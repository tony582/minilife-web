                    ...
                    <div className="rounded-2xl mb-4" style={{ background: C.bgCard }}>
                        ...
                        <div className="flex items-center gap-2 px-4 pb-4">
                            ...
                            <button onClick={() => {
                                ...
                                setEditingTask(null);
                                setPlanType('study');
                                setPlanForm({ targetKids: parentKidFilter === 'all' ? ['all'] : [parentKidFilter], category: '语文', iconName: getIconForCategory('语文'), title: '', desc: '', startDate: new Date().toISOString().split('T')[0], endDate: '', repeatType: 'today', weeklyDays: [1, 2, 3, 4, 5], ebbStrength: 'normal', periodDaysType: 'any', periodCustomDays: [1, 2, 3, 4, 5, 6, 7], periodTargetCount: 1, periodMaxPerDay: 1, periodMaxType: 'daily', timeSetting: 'range', startTime: defaultTimes.start, endTime: defaultTimes.end, durationPreset: 25, pointRule: 'default', reward: '', habitColor: 'from-blue-400 to-blue-500', habitType: 'daily_once', attachments: [], iconEmoji: null });
