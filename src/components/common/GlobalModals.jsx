...
export const GlobalModals = () => {
    ...
    const context = { ...authC, ...dataC, ...uiC, ...taskM, ...shopM, ...toastC, getCategoryGradient, getCategoryColor, getIconForCategory, allCategories, getCatHexColor, AvatarDisplay, renderIcon, getLevelReq, getLevelTier };
    const {
